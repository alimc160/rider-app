  ...
  <div class="container-fluid">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Vehicle categories list</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <button
                class="btn btn-sm btn-primary float-right"
                @click="addVehicleCategoryModal"
              ...
              <div class="card-body table-responsive p-0" style="mx-height: 500px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tr v-for="item in items">
                    <td> {{ item.title }}</td>
                    <td>
                      <a class="btn btn-sm btn-danger" @click.prevent="DeleteVehicleType(item.id)">
    ...
    <!-- /.content -->
    <AddVehicleCategoryModal></AddVehicleCategoryModal>
  </div>
</template>

<script>
import pagination from '@/components/global/pagination.vue';
import AddVehicleCategoryModal from "@/views/modals/AddVehicleCategoryModal";

export default {
  name: "VehicleCategoryView",
  props: [],
  components: {
  ...
  methods: {
    ...
    getdata() {
      axios.get('/api/admin/vehicle-category', {
        params: {
    ...
    addVehicleCategoryModal() {
      Emitter.emit("ADD-VEHICLE-CATEGORY-MODAL");
    },
    ...
    DeleteVehicleType(id) {
      this.$swal.fire({
        ...
        if (result.isConfirmed) {
          /*axios code started*/
          axios.delete('/api/admin/vehicle-category/' + id).then(response => {
            this.$swal({
              icon: 'success',
  ...
  created() {
    Emitter.on("UPDATE-VEHICLE-CATEGORY-DATA", (data) => {
      this.getdata();
    });
  },
